        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nom = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
                    SIREN = table.Column<string>(type: "TEXT", maxLength: 9, nullable: false),
                    RNA = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    Departement = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    ...
                    Ville = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssociationId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObjectifFinancier = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ImageUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Statut = table.Column<int>(type: "INTEGER", nullable: false),
                    DateCreation = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateCloture = table.Column<DateTime>(type: "TEXT", nullable: true),
                    GestionnaireId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cagnottes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cagnottes_AspNetUsers_GestionnaireId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CagnotteId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Associations_RNA",
                table: "Associations",
                column: "RNA");

            migrationBuilder.CreateIndex(
                name: "IX_Associations_SIREN",
                table: "Associations",
                column: "SIREN",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Cagnottes_DateCreation",
                table: "Cagnottes",
                column: "DateCreation");

            migrationBuilder.CreateIndex(
                name: "IX_Cagnottes_GestionnaireId",
                table: "Cagnottes",
                column: "GestionnaireId");

            migrationBuilder.CreateIndex(
                name: "IX_Cagnottes_Statut",
                table: "Cagnottes",
                column: "Statut");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participations_CagnotteId_ParticipantId",
                table: "Participations",
                columns: new[] { "CagnotteId", "ParticipantId" });
